...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-1-5异常的底层" tabindex="-1"><a class="header-anchor" href="#_1-1-5异常的底层" aria-hidden="true">#</a> 1.1.5异常的底层？</h3><p>提到JVM处理异常的机制，就需要提及Exception Table，以下称为异常表。我们暂且不急于介绍异常表，先看一个简单的 Java 处理异常的小例子。</p><div class="language-Java line-numbers-mode" data-ext="Java"><pre class="language-Java"><code>public static void simpleTryCatch() {
   try {
       testNPE();
   } catch (Exception e) {
       e.printStackTrace();
...
</code></pre>`,77),h={href:"https://blog.csdn.net/qq_33709582/article/details/113550163",target:"_blank",rel:"noopener noreferrer"};function v(g,m){const e=i("ExternalLinkIcon");return l(),r("div",null,[a("p",null,[o,n("："),a("a",d,[n("https://blog.csdn.net/yang13563758128/article/details/86655574?spm=1001.2014.3001.5502"),s(e)])]),u,a("p",null,[n("参考："),a("a",h,[n("https://blog.csdn.net/qq_33709582/article/details/113550163"),s(e)])])])}const M=t(p,[["render",v],["__file","1.异常和反射.html.vue"]]);export{M as default};
